...
var BottomNavBar = function (props) {
    ...
    return (react_1["default"].createElement(Tab.Navigator, { screenOptions: { headerShown: false } },
        ...
        react_1["default"].createElement(Tab.Screen, { name: "Profile", component: ProfileScreen_1["default"], options: {
                tabBarLabelStyle: { color: 'white' },
                tabBarStyle: { backgroundColor: 'rgb(39, 38, 39)' },
